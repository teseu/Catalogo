          ...
          <div class="navbar navbar-default" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
              <ul class="nav navbar-nav">
                ...
                <li <?php if($_GET['page'] == 'enderecos') {echo "class='active'";} ?>><a href="index.php?page=enderecos">Setores</a></li>
              ...
              <form class="navbar-form pull-right hidden-xs" role="search" action="index.php?page=enderecos"
